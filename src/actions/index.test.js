...
describe('actions testing', () => {
  ...
  let house =   {
    ...
    coatOfArms: 'Three black ravens in flight, holding three red hearts, ' +
      'on a white field(Argent, three ravens volant sable, ' +
  ...
  it(`should create a getHouseData action`, () => {
    ...
    expect(expectation.houseData.titles)
      .toEqual(["Lord of Heart's Home", "King of the Fingers (historical)"]);
    expect(expectation.houseData.coatOfArms)
      .toEqual('Three black ravens in flight, ' +
